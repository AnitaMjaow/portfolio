        ...
        <section className="pt-20 pb-24 md:pt-40 md:pb-48">
          ...
          <header className="text-center text-white">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm md:text-base text-white/70">
              Independent Designer & Developer. Crafting high-performance
          ...
          <div className="relative mt-16 md:mt-24">
            {/* ================= BENTO GRID ================= */}
            <section className="relative z-10 grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-6">
              {/* About / Philosophy */}
              <article
                className={`${CARD_BASE} p-6 md:col-span-4 md:col-start-1`}
              >
                <p className="text-xs uppercase tracking-widest text-white/50">
                  About
                </p>
                <h2 className="mt-3 text-lg font-semibold">
                  Frontend Developer · UX Experimentalist
                </h2>
                <p className="mt-2 text-sm text-white/70">
                  I'm Anita—pushing UX boundaries past the stars. I build fast,
                  minimal, high-performance interfaces with personality.
                </p>
              </article>
              ...
              >
                ...
                <p className="mt-4 text-sm text-white/70">
                  Some work is available upon request due to client agreements.
                  Reach out to unlock access.
                </p>
              ...
              {/* Quote */}
              <article
                className={`${CARD_BASE} p-6 flex items-center justify-center text-center italic md:col-span-4 md:col-start-9`}
              >
                “Let’s make the internet a little more interesting together.”
              </article>

              {/* Wide Image */}
              <article
                className={`${CARD_BASE} overflow-hidden md:col-span-12`}
              >
            ...
            w-[140%]
            -translate-x-1/2
            bg-[radial-gradient(ellipse_at_center,rgba(80,160,255,0.25),transparent_70%)]
            blur-3xl
          "
            />
          </div>
